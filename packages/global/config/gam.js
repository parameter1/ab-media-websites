...
module.exports = ({
  ...
  config
    .setTemplate('LEADERBOARD', {
      ...
      sizeMapping: [
        { viewport: [1070, 0], size: [[970, 250], [1060, 596], [265, 149]] },
        { viewport: [980, 0], size: [[970, 250], [736, 414], [265, 149]] },
        { viewport: [750, 0], size: [[300, 100], [736, 414], [265, 149]] },
        { viewport: [430, 0], size: [[300, 100], [428, 241], [265, 149]] },
        { viewport: [300, 0], size: [[300, 100], [265, 149]] },
      ],
    })
    .setTemplate('RAIL', {
      size: [300, 250],
