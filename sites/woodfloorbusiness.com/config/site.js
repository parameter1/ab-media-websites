...
module.exports = {
  ...
  logos: {
    navbar: {
      src: 'https://img.woodfloorbusiness.com/files/base/abmedia/all/image/static/wfb-site-logo.png?h=70&auto=format,compress&q=70',
      srcset: [
        'https://img.woodfloorbusiness.com/files/base/abmedia/all/image/static/wfb-site-logo.png?h=140&auto=format,compress&q=70 2x',
      ],
    },
    footer: {
